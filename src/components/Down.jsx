...
const Down=()=>{
    ...
    return(
        ...
        //     </div>
        // </nav>
        <nav className="sm:px-16 px-6 w-full flex flex-col sm:flex-row items-center py-5 top-0 z-20 bg-primary">
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white text-xl font-semibold cursor-pointer flex">SUSANTH &nbsp;</p>
          </Link>
          ...
          <ul className="list-none sm:flex flex-row gap-6">
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fab fa-github text-2xl w-8 h-8 cursor-pointer"
              ></a>
            </li>
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fab fa-linkedin text-2xl w-8 h-8 cursor-pointer"
              ></a>
            </li>
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="fab fa-instagram text-2xl w-8 h-8 cursor-pointer"
              ></a>
            </li>
          </ul>
        </div>
